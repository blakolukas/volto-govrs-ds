...
export const Default: Story = {
  args: {
    ...
    description:
      'Esta é uma descrição do conteúdo do card. Pode conter múltiplas linhas de texto.',
    variant: 'post',
...
export const WithBodyImage: Story = {
  args: {
    ...
    href: 'https://www.rs.gov.br/',
    children:
      'O bodyImg permite adicionar uma imagem destacada no corpo do card, ideal para posts com foto em destaque.',
    bodyImg:
