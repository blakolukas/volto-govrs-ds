...
export const WithContent: Story = {
  args: {
    ...
    variant: 'news',
    children:
      'Esta é a área de conteúdo principal do card de notícia. Pode incluir texto adicional ou elementos conforme necessário. O conteúdo aqui fornece informações mais detalhadas relacionadas ao título e descrição do card.',
    href: 'https://www.rs.gov.br/',
  },
};
